...
class UserServiceTest {
  ...
  @Mock private HarpProxyService harpProxyService;
  ...
  @Test
  void refreshUserRolesAndLoginWithValidToken() {
  ...
  @Test
  void refreshUserRolesAndLoginWithNullToken() {
  ...
  @Test
  void refreshUserRolesAndLoginWithBlankToken() {
